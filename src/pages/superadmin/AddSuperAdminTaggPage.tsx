...
//const { user, setUser, isAuthenticated } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axiosInstance.post('/superadmin/tagg/add', taggData, {
  ...
  return (
    ...
    <NavLink to="/superadmin/taggs" className="text-blue-500 hover:underline font-bold text-sm">
        &rsaquo; View Tags
    </NavLink> 
    </p>
    </div>
      ...
      <div className="p-8 rounded border border-gray-200 w-full max-w-3xl mx-auto">
        <h2 className="font-medium text-3xl">Add Tag</h2>
        <form onSubmit={handleSubmit}>
          <div className="mt-3 grid lg:grid-cols-1 gap-4 w-full">
            ...
            <div>
              ...
              />
              {nameAvailable === false && (
                <p className="text-red-500 text-sm">Tag exists.</p>
              )}
              {nameAvailable === true &&  (
                <p className="text-green-600 text-sm">Tag available.</p>
              )}
...
export default AddSuperAdminTaggPage;
